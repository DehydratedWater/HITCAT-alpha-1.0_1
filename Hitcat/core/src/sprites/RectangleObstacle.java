...
public class RectangleObstacle extends RectangleInteractiveObject implements GameConstants {
	

	public RectangleObstacle(World world, TiledMap map, Rectangle bounds) {
